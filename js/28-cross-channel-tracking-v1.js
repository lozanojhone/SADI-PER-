...
if(q.get('sadi_source')==='qr-oficial'||q.get('sadi_origin')==='catalogo'){localStorage.setItem(ATTR_KEY,JSON.stringify({source:q.get('sadi_source')||'qr-oficial',originChannel:'catalogo',campaign:'catalogo_roy',startedAt:Date.now(),expiresAt:Date.now()+TTL}));}
